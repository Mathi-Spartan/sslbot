...
export function CreatePartnerForm() {
  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-5">
      {created ? (
        <div>
          <p className="text-sm font-medium text-slate-900">Partner created.</p>
          <p className="mt-2 text-sm text-slate-600">
            Share these login details with the partner — they should change the password
            after first sign-in.
          </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-xs font-medium text-slate-700">Allocation type</label>
              <select name="allocation_type" className="mt-1 w-full rounded-md border border-slate-300 px-3 py-1.5 text-sm">
            ...
            <div />
            <div>
              <label className="block text-xs font-medium text-slate-700">Initial credits</label>
            ...
            <div>
              <label className="block text-xs font-medium text-slate-700">Initial wallet ($)</label>
